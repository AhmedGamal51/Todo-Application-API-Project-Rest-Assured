...
public class UserTest {
    ...
    @Story("Should Not Be Able To Login If The Password Not Correct")
    @Test(description = "Should Not Be Able To Login If The Password Not Correct")
    public void shouldNotBeAbleToLoginIfThePasswordNotCorrect(){
        User user = UserSteps.getRegisteredUser();
